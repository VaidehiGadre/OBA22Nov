...
public class UserController {
	...
	public ModelAndView userprofileprocess(@RequestParam String aadhar_no,@RequestParam String f_name,@RequestParam String l_name,@RequestParam String m_name,@RequestParam String fathers_name,@RequestParam int mobile_no,@RequestParam String email_id,@RequestParam Date dob,@RequestParam String res_addr,@RequestParam String per_addr,@RequestParam String occ_details){
